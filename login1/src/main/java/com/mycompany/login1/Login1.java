...
public class Login {
    ...
    // Database simulation
    public static Map<String, Login1> users = new HashMap<>();

    // Add user to database
    public static void setDB(String username, String firstName, String lastName, String phone, String password) {
        users.put(username, new Login1(firstName, lastName, username, phone, password));
    }
    ...
    public static void main(String[] args) {
        ...
        if (loggedIn) {
                ...
                switch (choice) {
                    ...
                    case 1:
                        ...
                        for (int i = 1; i <= totalMessages; i++) {
                            ...
                            massage msg = new massage(i, sender, recipient, text);
            ...
            System.out.println("You must log in successfully.");
        }
